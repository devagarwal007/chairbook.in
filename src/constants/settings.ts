...
export const INITIAL_DATA: SettingsData = {
  ...
  services: [
    ...
    { id: "bundle-1", kind: "bundle", name: "Bridal Glow", cat: "Bundles", duration: 195, price: 2300, active: true, componentIds: [2, 4, 6], bundle_note: "Most-booked combo before weddings" },
    { id: "bundle-2", kind: "bundle", name: "Hair Refresh", cat: "Bundles", duration: 90, price: 1000, active: true, componentIds: [1, 3], bundle_note: "" },
  ],
  team: [
